...
if (document.getElementById('typing-area')) {
    const texts = [
        ...
        "Программирование — это удивительный процесс создания виртуальных миров из простых строк логического кода.",
        "Глубоко в океане обитают удивительные существа, которые светятся в полной темноте собственной неоновой магией.",
        "Прогулка по старому весеннему парку после теплого дождя всегда наполняет мысли свежестью и спокойствием.",
        "Технологии развиваются с невероятной скоростью, открывая перед человечеством двери в удивительное цифровое будущее.",
        "Космический корабль безмолвно скользил мимо далеких звезд, направляясь к неизведанным таинственным планетам.",
        "Чтение хорошей бумажной книги способно перенести нас в совершенно иную эпоху или даже параллельную вселенную.",
        "Горячий чарующий кофе ранним утром помогает настроиться на продуктивный лад и встретить новый день с улыбкой."
    ];
